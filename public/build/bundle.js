...
var app = (function () {
    ...
    /* src/ContactCaqrd.svelte generated by Svelte v3.59.2 */

    const file$1 = "src/ContactCaqrd.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-wcqosw");
    			add_location(img, file$1, 68, 8, 1272);
    			attr_dev(div0, "class", "thumb svelte-wcqosw");
    			toggle_class(div0, "thumb-placeholder", !/*imagePath*/ ctx[2]);
    			add_location(div0, file$1, 67, 8, 1205);
    			attr_dev(h1, "class", "svelte-wcqosw");
    			add_location(h1, file$1, 71, 8, 1364);
    			attr_dev(h2, "class", "svelte-wcqosw");
    			add_location(h2, file$1, 72, 8, 1392);
    			attr_dev(div1, "class", "user-data svelte-wcqosw");
    			add_location(div1, file$1, 70, 6, 1332);
    			attr_dev(header, "class", "svelte-wcqosw");
    			add_location(header, file$1, 65, 4, 1111);
    			add_location(p, file$1, 77, 6, 1517);
    			attr_dev(div2, "class", "description svelte-wcqosw");
    			add_location(div2, file$1, 75, 4, 1443);
    			attr_dev(div3, "class", "contact-card svelte-wcqosw");
    			add_location(div3, file$1, 64, 2, 1080);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_slots('ContactCaqrd', slots, []);
    	let { userName } = $$props;
    	let { jobTitle } = $$props;
    	let { imagePath } = $$props;
    	...
    	$$self.$$.on_mount.push(function () {
    		if (userName === undefined && !('userName' in $$props || $$self.$$.bound[$$self.$$.props['userName']])) {
    			console.warn("<ContactCaqrd> was created without expected prop 'userName'");
    		}

    		if (jobTitle === undefined && !('jobTitle' in $$props || $$self.$$.bound[$$self.$$.props['jobTitle']])) {
    			console.warn("<ContactCaqrd> was created without expected prop 'jobTitle'");
    		}

    		if (imagePath === undefined && !('imagePath' in $$props || $$self.$$.bound[$$self.$$.props['imagePath']])) {
    			console.warn("<ContactCaqrd> was created without expected prop 'imagePath'");
    		}

    		if (description === undefined && !('description' in $$props || $$self.$$.bound[$$self.$$.props['description']])) {
    			console.warn("<ContactCaqrd> was created without expected prop 'description'");
    		}
    	});

    	const writable_props = ['userName', 'jobTitle', 'imagePath', 'description'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ContactCaqrd> was created with unknown prop '${key}'`);
    	});
    	...
    	return [userName, jobTitle, imagePath, description];
    }

    class ContactCaqrd extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get userName() {
    		throw new Error("<ContactCaqrd>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set userName(value) {
    		throw new Error("<ContactCaqrd>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment(ctx) {
    	...
    	contactcard = new ContactCaqrd({
    			props: {
    				userName: /*name*/ ctx[0],
    				jobTitle: /*title*/ ctx[1],
    				description: /*description*/ ctx[3],
    				imagePath: /*imageUrl*/ ctx[2]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 38, 0, 519);
    			add_location(button, file, 39, 0, 568);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "name");
    			add_location(input0, file, 43, 0, 751);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "title");
    			add_location(input1, file, 44, 0, 811);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "placeholder", "imageUrl");
    			add_location(input2, file, 46, 0, 873);
    			attr_dev(textarea, "row", "3");
    			add_location(textarea, file, 48, 0, 941);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*imageUrl*/ 4) contactcard_changes.imagePath = /*imageUrl*/ ctx[2];
